#include "MJRenderTargetSSAO.h"
#include "Vulkan.h"
#include "GPipeline.h"
#include "GCommandBuffer.h"


MJRenderTargetSSAO::MJRenderTargetSSAO(Vulkan* vulkan_,
    ivec2 size_)
{
    vulkan = vulkan_;
    size = size_;
   ...
   // for(int i = 0; i < bufferCount; i++)
    {
		...
		//MJLog("vmaCreateImage p:0x%p",depthImage);
...
MJRenderTargetSSAO::~MJRenderTargetSSAO()
{
...
void MJRenderTargetSSAO::lock(GCommandBuffer* commandBuffer)
{
...
void MJRenderTargetSSAO::unlock(GCommandBuffer* commandBuffer)
{
